...
// Usage: node mcq_cli.js '{"model_answers": "1A 2B 3C 4D", "student_answers": "1 a 2 b 3 c 4 d"}'
...
if (args.length === 0) {
  console.log('Usage: node mcq_cli.js \'{"model_answers": "1A 2B 3C 4D", "student_answers": "1 a 2 b 3 c 4 d"}\'');
  console.log('Or: node mcq_cli.js --model "1A 2B 3C 4D" --student "1 a 2 b 3 c 4 d"');
  process.exit(1);
}
